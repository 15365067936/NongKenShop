$().ready(function() {
    ...
    $("#agreementWindow").jqm({
        ...
        onShow: function(hash) {
            var data = ' <p>用户通过完成注册程序，表示用户承诺并同意遵守以下义务： <br> 1） 用户在申请使用网络服务和在网站上进行注册时， 应该提供准确、 真实、 最新的个人资料， 如个人资料有任何变动， 应及时更新；<br> 2） 用户应确保自己用户名及密码的安全性， 并对通过该账户所进行的所有行为承担相应的法律后果；<br> 3） 甲方必须遵守中华人民共和国所有适用的法律和法规的规定， 不得使用乙方网络服务做非法用途；<br> 4） 用户遵守农肯农业科技有限公司有关的网络协议、 规定和程序， 不得利用网络服务系统进行任何可能对互联网或农肯农业科技有限公司正常运转造成不利影响的行为；</br> 5） 用户不得利用网络服务系统或向网站、 论坛等上传、 展示或传播任何虚假的、 骚扰性的、 中伤他人的、 辱骂性的、 恐吓性的、 庸俗淫秽的、 或其他任何非法的、 不道德的信息资料；<br> 6） 用户不得以任何形式侵犯农肯农业科技有限公司和其他任何第三方的知识产权、 名誉权和其他任何合法权益。 </ p> ';
            ...
            // 		},
            // 		url: JFinalshop.base + "/shop/member/agreement",
