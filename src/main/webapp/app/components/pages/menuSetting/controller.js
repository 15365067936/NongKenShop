...
module.exports = function($scope, $resource, $uibModal, userService){
    ...
    $resource('/qq/sys/menu/getMenuList?accessId=' + $scope.currentApp.userAccessId).get().$promise.then(function (data) {
                console.log(data);
                $scope.mynodes = JSON.parse(data.content);
            });
    ...
    $scope.publish = function () {
        ...
        modalInstance.result.then(function () {
            var url = '/qq/sys/menu/createMenu?accessId=' + $scope.currentApp.userAccessId;
